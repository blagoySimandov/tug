...
export const MOCK_MOMENTS: Record<string, ImportantMomentsResponse> = {
  arg_fr: [
    { type: "goal", videoId: "arg_fr", videoTimestamp: 10, importanceScore: 0.9 },
    { type: "red_card", videoId: "arg_fr", videoTimestamp: 30, importanceScore: 0.75 },
    { type: "goal", videoId: "arg_fr", videoTimestamp: 60, importanceScore: 0.95 },
  ],
  "video-1": [
  ...
  "video-2": [{ type: "goal", videoId: "video-2", videoTimestamp: 900, importanceScore: 0.8 }],
};
...
export function getMockMoments(
  ...
  return moments.filter((m) => m.videoTimestamp >= timestampStart && m.videoTimestamp <= timestampEnd);
}
